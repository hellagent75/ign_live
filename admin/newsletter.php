...
<link href="http://www.phantoms-esports.com/newsletter/layout/layout.css" rel="stylesheet" type="text/css" />
</head>
<body>
  <div id="wrapper">
    <div id="header">
      <a href="http://www.phantoms-esports.com/" class="pmlogo" target="_blank"></a>
      <span>
        Newsletter<br />
        <p>www.phantoms-esports.com</p>
      </span>
    </div>
    <div id="newsletter">
      <div id="inner">
    ...
    <div id="footer">
      You can remove yourself from the mailing-list at your <a href="http://www.phantoms-esports.com/settings/" target="_blank"><b>Profile Settings</b></a>.
    </div>
  </div>
</body>
</html>
'; 
		...
		foreach($bcc as $mailto) {
			if(!mail($mailto, $title,$emailbody,$header)) $succces = false;
		}
