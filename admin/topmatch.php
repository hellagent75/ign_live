...
safe_query("INSERT INTO ".PREFIX."topmatch (date, matchlink, league, maps, server, teamclan, country1, team1, homepage1, country2, team2, homepage2, displayed, game, report)
	             values('$date', '$matchlink', '$league', '$maps', '$server','$teamclan','$country1', '$team1', '$homepage1', '$country2', '$team2', '$homepage2', '$displayed', '$game', '$report' )");
...
<td><table width="100%" border="0" cellspacing="1" cellpadding="3">
<tr>
<td valign="top" width="130"><b>'.$_language->module['report'].'</b></td>
<td><textarea name="report" cols="30" rows="5" class="form_off" onFocus="this.className=\'form_on\'" onBlur="this.className=\'form_off\'"></textarea></td>
</tr>
</table></td>
</tr>
</table></td>
...
<tr>
<td valign="top" width="130"><b>'.$_language->module['report'].'</b></td>
<td><textarea name="report" cols="30" rows="5" class="form_off" onFocus="this.className=\'form_on\'" onBlur="this.className=\'form_off\'">'.$ds['report'].'</textarea></td>
</tr>
</table></td>
</tr>
</table></td>
...
</table><p>'.$_language->module['no_entries'].'</p>';
