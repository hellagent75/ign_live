...
elseif($action=="write") {
  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    ...
    <tr>
      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="0" class="none_table">
        <tr>
          <td class="td2" width="15%"><b>'.$_language->module['backup_file'].'</b></td>
          <td class="td2" width="85%"><input name="sql" type="file" size="40" /></td>
        </tr>
        <tr>
          <td class="td1"><input type="hidden" name="captcha_hash" value="'.$hash.'" /></td>
          <td class="td1"><input type="submit" name="upload" value="'.$_language->module['upload'].'" /></td>
        </tr>
      </table>
      </td>
    </tr>
