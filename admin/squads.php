...
if(isset($_POST['save'])) {
	...
	if($CAPCLASS->check_captcha(0, $_POST['captcha_hash'])) {
		...
		if(checkforempty(Array('name'))) {
			...
			safe_query("INSERT INTO ".PREFIX."squads ( gamesquad, games, name, info, sort, displayed ) VALUES ( '".$_POST['gamesquad']."', '".$games."', '".$_POST['name']."', '".$_POST['message']."', '1', '1' )");
...
if($action=="add") {
  ...
  <table width="100%" border="0" cellspacing="1" cellpadding="3">
	...
	<table width="100%" border="0" cellspacing="1" cellpadding="3">
      <tr>
        <td width="15%"><b>Displayed?</b></td>
        <td width="85%"><select name="displayed"><option selected="selected" value="1">Yes</option><option value="0">No</option></select></td>
      </tr>
    </table>
    </div>
    <table width="100%" border="0" cellspacing="1" cellpadding="3">
...
elseif($action=="edit") {
  ...
  echo'<h1>&curren; <a href="admincenter.php?site=squads" class="white">'.$_language->module['squads'].'</a> &raquo; '.$_language->module['edit_squad'].'</h1>';
	...
	$displayinfo = $ds['displayed'];
	if($displayinfo == 1) $displayinfo = '';
	elseif($displayinfo == 0) $displayinfo = 'selected="selected"';
  ...
  <table width="100%" border="0" cellspacing="1" cellpadding="3">
      <tr>
        <td width="15%"><b>Displayed?</b></td>
        <td width="85%"><select name="displayed"><option '.$displayinfo.' value="1">Yes</option><option '.$displayinfo.' value="0">No</option></select></td>
      </tr>
    </table>
  </div>
  <table width="100%" border="0" cellspacing="1" cellpadding="3">
