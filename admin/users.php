...
elseif($action=="profile") {
  ...
  if($ds['userpic']) $viewpic='<a href="javascript:MM_openBrWindow(\'../images/userpics/'.$ds['userpic'].'\',\'userpic\',\'width=260,height=340\')">Userpic</a>';
  else $viewpic=$_language->module['picture'];
  
  if($ds['userbanner']) $viewbanner='<a href="javascript:MM_openBrWindow(\'../images/userbanner/'.$ds['userbanner'].'\',\'userpic\',\'width=1000,height=250\')">Userbanner</a>';
  else $viewpic=$_language->module['picture'];
  
  if($ds['avatar']) $viewavatar='<a href="javascript:MM_openBrWindow(\'../images/avatars/'.$ds['avatar'].'\',\'avatar\',\'width=100,height=100\')">'.$_language->module['avatar'].'</a>';
  ...
  <table width="100%" border="0" cellspacing="1" cellpadding="3">
    ...
    <tr>
      ...
      <td><input type="text" name="nickname" value="'.$ds['nickname'].'" size="60" disable="disabled" /></td>
    </tr>
    <tr>
    ...
    <tr>
      <td colspan="2"><br/><h1>Avatars</h1></td>
    </tr>
    
	<tr>
      <td><b>'.$viewavatar.'</b></td>
      <td><input name="avatar" type="file" size="40" /> <small>100x100px</small></td>
    </tr>
    ...
    <tr>
      <td><b>'.$viewpic.'</b></td>
      <td><input name="userpic" type="file" size="40" /> <small>280x280px</small></td>
    </tr>
    <tr>
      <td></td>
      <td><input type="checkbox" name="userpic" value="1" /> delete Userpic</td>
    </tr>
	
	<tr>
      <td><b>'.$viewbanner.'</b></td>
      <td><input name="userpic" type="file" size="40" /> <small>1000x250px</small></td>
    </tr>
	
    <tr>
      <td></td>
      <td><input type="checkbox" name="userpic" value="1" />delete Banner</td>
    </tr>
	
    <tr>
      <td colspan="2"><br /><h1>User Details</h1></td>
    </tr>
    <tr>
    ...
    <tr>
      <td colspan="2"><br /><h1>Social</h1></td>
    </tr>
	...
	<tr>
      <td colspan="2"><br /><h1>Hardware</h1></td>
    </tr>
