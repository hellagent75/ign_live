...
elseif(isset($_POST['save'])) {
	...
	$boardico = $_POST['boardico'];
	$boardico_grp = $_POST['boardico_grp'];
	...
	$CAPCLASS = new Captcha;
	if($CAPCLASS->check_captcha(0, $_POST['captcha_hash'])) {
  		safe_query("INSERT INTO ".PREFIX."forum_boards ( category, name, info, readgrps, writegrps, sort, boardico, boardico_grp, visibility )
  values( '$kath', '$name', '$boardinfo', '$readgrps', '$writegrps', '1', '$boardico', '$boardico_grp', '$visibility' )");
  	} else echo $_language->module['transaction_invalid'];
}
...
elseif(isset($_POST['savecat'])) {
	...
	$catico = $_POST['catico'];
	$catico_grp = $_POST['catico_grp'];
	if(isset($_POST['readgrps'])) $readgrps = implode(";", $_POST['readgrps']);
	else $readgrps='';
	$CAPCLASS = new Captcha;
	if($CAPCLASS->check_captcha(0, $_POST['captcha_hash'])) {
		safe_query("INSERT INTO ".PREFIX."forum_categories ( readgrps, name, info, sort, catico, catico_grp ) values( '$readgrps', '$catname', '$catinfo', '1', '$catico', '$catico_grp' )");
	} else echo $_language->module['transaction_invalid'];
}
...
elseif(isset($_POST['saveeditcat'])) {
	...
	$CAPCLASS = new Captcha;
	if($CAPCLASS->check_captcha(0, $_POST['captcha_hash'])) {
		safe_query("UPDATE ".PREFIX."forum_categories SET readgrps='$readgrps', name='$catname', info='$catinfo', catico='$catico', catico_grp='$catico_grp' WHERE catID='$catID' ");
	} else echo $_language->module['transaction_invalid'];
}
...
function show_no() {
	document.getElementById(\'ico_games\').style.display = \'none\';
	document.getElementById(\'ico_countries\').style.display = \'none\';
	document.getElementById(\'ico_smileys\').style.display = \'none\';
	document.getElementById(\'ico_self\').style.display = \'none\';
}
function show_games() {
	document.getElementById(\'ico_games\').style.display = \'block\';
	document.getElementById(\'ico_countries\').style.display = \'none\';
	document.getElementById(\'ico_smileys\').style.display = \'none\';
	document.getElementById(\'ico_self\').style.display = \'none\';

	document.getElementById(\'ico_games\').name = \'boardico\';
	document.getElementById(\'ico_countries\').name = \'ico_countries\';
	document.getElementById(\'ico_smileys\').name = \'ico_smileys\';
	document.getElementById(\'ico_self\').name = \'ico_self\';
}
function show_countries() {
	document.getElementById(\'ico_games\').style.display = \'none\';
	document.getElementById(\'ico_countries\').style.display = \'block\';
	document.getElementById(\'ico_smileys\').style.display = \'none\';
	document.getElementById(\'ico_self\').style.display = \'none\';

	document.getElementById(\'ico_games\').name = \'ico_games\';
	document.getElementById(\'ico_countries\').name = \'boardico\';
	document.getElementById(\'ico_smileys\').name = \'ico_smileys\';
	document.getElementById(\'ico_self\').name = \'ico_self\';
}
function show_smileys() {
	document.getElementById(\'ico_games\').style.display = \'none\';
	document.getElementById(\'ico_countries\').style.display = \'none\';
	document.getElementById(\'ico_smileys\').style.display = \'block\';
	document.getElementById(\'ico_self\').style.display = \'none\';

	document.getElementById(\'ico_games\').name = \'ico_games\';
	document.getElementById(\'ico_countries\').name = \'ico_countries\';
	document.getElementById(\'ico_smileys\').name = \'boardico\';
	document.getElementById(\'ico_self\').name = \'ico_self\';
}
function show_self() {
	document.getElementById(\'ico_games\').style.display = \'none\';
	document.getElementById(\'ico_countries\').style.display = \'none\';
	document.getElementById(\'ico_smileys\').style.display = \'none\';
	document.getElementById(\'ico_self\').style.display = \'block\';

	document.getElementById(\'ico_games\').name = \'ico_games\';
	document.getElementById(\'ico_countries\').name = \'ico_countries\';
	document.getElementById(\'ico_smileys\').name = \'ico_smileys\';
	document.getElementById(\'ico_self\').name = \'boardico\';
}	
	-->
	</script>';
	...
	while($gl=mysql_fetch_array($gamelist))
	{
		$ico_games .= '<option value="'.$gl['tag'].'">'.$gl['name'].'</option>';
	}

	$ico_countries = '';
	$countrieslist=safe_query("SELECT * FROM ".PREFIX."countries ORDER BY country");
	while($cl=mysql_fetch_array($countrieslist))
	{
		$ico_countries .= '<option value="'.$cl['short'].'">'.$cl['country'].'</option>';
	}

	$ico_smileys = '';
	$smileylist=safe_query("SELECT * FROM ".PREFIX."smileys ORDER BY alt");
	while($sml=mysql_fetch_array($smileylist))
	{
		$ico_smileys .= '<option value="'.$sml['name'].'">'.$sml['alt'].'</option>';
	}

	$ico_self = '';
	$selflist=safe_query("SELECT * FROM ".PREFIX."forum_ico ORDER BY name");
	while($sl=mysql_fetch_array($selflist))
	{
		$ico_self .= '<option value="'.$sl['tag'].'">'.$sl['name'].'</option>';
	}
  ...
  <table width="100%" border="0" cellspacing="1" cellpadding="3">
    ...
    <tr>
      <td valign="top"><b>'.$_language->module['board_ico'].'</b></td>
      <td>
<input onclick="show_no()" type="radio" name="boardico_grp" value="0" checked="checked" />'.$_language->module['ico_no'].'<br/>
<input onclick="show_games()" type="radio" name="boardico_grp" value="1" />'.$_language->module['ico_games'].'<br/>
<input onclick="show_countries()" type="radio" name="boardico_grp" value="2" />'.$_language->module['ico_countries'].'<br/>
<input onclick="show_smileys()" type="radio" name="boardico_grp" value="3" />'.$_language->module['ico_smileys'].'<br/>
<input onclick="show_self()" type="radio" name="boardico_grp" value="4" />'.$_language->module['ico_self'].'<br/>
	  </td>
    </tr>
    <tr>
      <td></td>
      <td>
	  	<select style="display:none" id="ico_games" >'.$ico_games.'</select>
	  	<select style="display:none" id="ico_countries" >'.$ico_countries.'</select>
	  	<select style="display:none" id="ico_smileys" >'.$ico_smileys.'</select>
		<select style="display:none" id="ico_self" >'.$ico_self.'</select>
	  </td>
    </tr>
    <tr>
      <td valign="top"><b>'.$_language->module['ico_choose'].'</b></td>
      <td>    
		  <select name="visibility">
			  <option value="1">'.$_language->module['board_ico'].'</option>
			  <option value="0">'.$_language->module['category_ico'].'</option>
		  </select> '.$_language->module['ico_display_info'].'
	  </td>
    </tr>	
    <tr>
...
elseif($action=="edit") {
  ...
  $boardID = $_GET['boardID'];
	...
	$ergebnis=safe_query("SELECT * FROM ".PREFIX."forum_boards WHERE boardID='$boardID'");
	$ds=mysql_fetch_array($ergebnis);
	if ($ds['boardico_grp']=="1") 	$showico='<img src="../images/games/'.$ds['boardico'].'.gif" alt="ICO" />';
	elseif ($ds['boardico_grp']=="2") $showico='<img src="../images/flags/'.$ds['boardico'].'.gif" alt="ICO" />';
	elseif ($ds['boardico_grp']=="3") $showico='<img src="../images/smileys/'.$ds['boardico'].'" alt="ICO" />';
	elseif ($ds['boardico_grp']=="4") $showico='<img src="../images/forumico/'.$ds['boardico'].'.jpg" alt="ICO" />';
	else $showico='';	
...
function no_change() {
	...
	document.getElementById(\'ico_smileys\').name = \'ico_smileys\';
	document.getElementById(\'ico_self\').name = \'ico_self\';
	document.getElementById(\'ico_same\').name = \'boardico\';
}
function delete_ico() {
	document.getElementById(\'ico_games\').style.display = \'none\';
	document.getElementById(\'ico_countries\').style.display = \'none\';
...
function show_self() {
	...
	if ($ds['visibility']=="1") $chooseico='<select name="visibility">
											  <option value="1" selected="selected">'.$_language->module['board_ico'].'</option>
											  <option value="0">'.$_language->module['category_ico'].'</option>
										  </select>';
	else $chooseico='<select name="visibility">
					  <option value="1">'.$_language->module['board_ico'].'</option>
					  <option value="0" selected="selected">'.$_language->module['category_ico'].'</option>
				  </select>';									  
  ...
  <table width="100%" border="0" cellspacing="1" cellpadding="3">
    ...
    <tr>
      <td><b>'.$_language->module['ico_current'].'</b></td>
      <td>&nbsp;'.$showico.'</td>
    </tr>
    <tr>
      <td valign="top"><b>'.$_language->module['ico_settings'].'</b></td>
      <td>
<input onclick="no_change()" 		type="radio" name="boardico_grp" value="'.$ds['boardico_grp'].'" checked="checked" />'.$_language->module['ico_no_change'].'<br/>
<input onclick="delete_ico()"		type="radio" name="boardico_grp" value="0"  />'.$_language->module['ico_no'].'<br/>
<input onclick="show_games()" 		type="radio" name="boardico_grp" value="1" />'.$_language->module['ico_games'].'<br/>
<input onclick="show_countries()" 	type="radio" name="boardico_grp" value="2" />'.$_language->module['ico_countries'].'<br/>
<input onclick="show_smileys()" 	type="radio" name="boardico_grp" value="3" />'.$_language->module['ico_smileys'].'<br/>
<input onclick="show_self()" 		type="radio" name="boardico_grp" value="4" />'.$_language->module['ico_self'].'<br/>
    ...
    <tr>
      <td></td>
      <td>
	    <select style="display:none" id="ico_same" name="boardico" ><option value="'.$ds['boardico'].'">'.$ds['boardico'].'</option></select>
		<select style="display:none" id="ico_games" >'.$ico_games.'</select>
	  	<select style="display:none" id="ico_countries" >'.$ico_countries.'</select>
	  	<select style="display:none" id="ico_smileys" >'.$ico_smileys.'</select>
		<select style="display:none" id="ico_self" >'.$ico_self.'</select>
    ...
    <tr>
      <td valign="top"><b>'.$_language->module['ico_choose'].'</b></td>
      <td>'.$chooseico.'<br/><br/>'.$_language->module['ico_display_info'].'</td>
    </tr>	
    <tr>
      <td valign="top"><b>'.$_language->module['read_right'].'</b></td>
...
function show_games() {
	...
	document.getElementById(\'ico_games\').name = \'catico\';
	document.getElementById(\'ico_countries\').name = \'ico_countries\';
	document.getElementById(\'ico_smileys\').name = \'ico_smileys\';
	document.getElementById(\'ico_self\').name = \'ico_self\';
}
function show_countries() {
	...
	document.getElementById(\'ico_games\').name = \'ico_games\';
	document.getElementById(\'ico_countries\').name = \'catico\';
	document.getElementById(\'ico_smileys\').name = \'ico_smileys\';
	document.getElementById(\'ico_self\').name = \'ico_self\';
}
function show_smileys() {
	...
	document.getElementById(\'ico_games\').name = \'ico_games\';
	document.getElementById(\'ico_countries\').name = \'ico_countries\';
	document.getElementById(\'ico_smileys\').name = \'catico\';
	document.getElementById(\'ico_self\').name = \'ico_self\';
}
function show_self() {
	document.getElementById(\'ico_games\').style.display = \'none\';
	...
	document.getElementById(\'ico_countries\').name = \'ico_countries\';
	document.getElementById(\'ico_smileys\').name = \'ico_smileys\';
	document.getElementById(\'ico_self\').name = \'catico\';
}
	-->
	</script>';
//
...
//
  ...
  <table width="100%" border="0" cellspacing="1" cellpadding="3">
    ...
    <tr>
      <td valign="top"><b>'.$_language->module['category_ico'].'</b></td>
      <td>
<input onclick="show_no()" type="radio" name="catico_grp" value="0" checked="checked" />'.$_language->module['ico_no'].'<br/>
<input onclick="show_games()" type="radio" name="catico_grp" value="1" />'.$_language->module['ico_games'].'<br/>
<input onclick="show_countries()" type="radio" name="catico_grp" value="2" />'.$_language->module['ico_countries'].'<br/>
<input onclick="show_smileys()" type="radio" name="catico_grp" value="3" />'.$_language->module['ico_smileys'].'<br/>
<input onclick="show_self()" type="radio" name="catico_grp" value="4" />'.$_language->module['ico_self'].'<br/>
	  </td>
    </tr>
    <tr>
      <td></td>
...
elseif($action=="editcat") {
  ...
  echo'<h1>&curren; <a href="admincenter.php?site=boards" class="white">'.$_language->module['boards'].'</a> &raquo; '.$_language->module['edit_category'].'</h1>';
	...
	if ($ds['catico_grp']=="1") 	$showico='<img src="../images/games/'.$ds['catico'].'.gif" alt="ICO" />';
	elseif ($ds['catico_grp']=="2") $showico='<img src="../images/flags/'.$ds['catico'].'.gif" alt="ICO" />';
	elseif ($ds['catico_grp']=="3") $showico='<img src="../images/smileys/'.$ds['catico'].'" alt="ICO" />';
	elseif ($ds['catico_grp']=="4") $showico='<img src="../images/forumico/'.$ds['catico'].'.jpg" alt="ICO" />';
	else $showico='';
...
function no_change() {
	...
	document.getElementById(\'ico_smileys\').name = \'ico_smileys\';
	document.getElementById(\'ico_self\').name = \'ico_self\';
	document.getElementById(\'ico_same\').name = \'catico\';
}
function delete_ico() {
	document.getElementById(\'ico_games\').style.display = \'none\';
	document.getElementById(\'ico_countries\').style.display = \'none\';
...
function show_self() {
  ...
  <table width="100%" border="0" cellspacing="1" cellpadding="3">
    ...
    <tr>
      <td valign="top"><b>'.$_language->module['ico_settings'].'</b></td>
      <td>
<input onclick="no_change()" 		type="radio" name="catico_grp" value="'.$ds['catico_grp'].'" checked="checked" />'.$_language->module['ico_no_change'].'<br/>
<input onclick="delete_ico()"		type="radio" name="catico_grp" value="0"  />'.$_language->module['ico_no'].'<br/>
<input onclick="show_games()" 		type="radio" name="catico_grp" value="1" />'.$_language->module['ico_games'].'<br/>
<input onclick="show_countries()" 	type="radio" name="catico_grp" value="2" />'.$_language->module['ico_countries'].'<br/>
<input onclick="show_smileys()" 	type="radio" name="catico_grp" value="3" />'.$_language->module['ico_smileys'].'<br/>
<input onclick="show_self()" 		type="radio" name="catico_grp" value="4" />'.$_language->module['ico_self'].'<br/>
    ...
    <tr>
      <td></td>
      <td>
	    <select style="display:none" id="ico_same" name="catico" ><option value="'.$ds['catico'].'">'.$ds['catico'].'</option></select>
		<select style="display:none" id="ico_games" >'.$ico_games.'</select>
	  	<select style="display:none" id="ico_countries" >'.$ico_countries.'</select>
	  	<select style="display:none" id="ico_smileys" >'.$ico_smileys.'</select>
		<select style="display:none" id="ico_self" >'.$ico_self.'</select>
  ...
  <table width="100%" border="0" cellspacing="1" cellpadding="3" bgcolor="#DDDDDD">
    <tr>
	  <td width="5%" class="title" align="center"><b>Icon</b></td>
  	  <td width="5%" class="title" align="center"><b>'.$_language->module['ico_display'].'</b></td>
      <td width="50%" class="title"><b>'.$_language->module['boardname'].'</b></td>
      <td width="10%" class="title" align="center"><b>'.$_language->module['mods'].'</b></td>
      <td width="20%" class="title" align="center"><b>'.$_language->module['actions'].'</b></td>
      <td width="10%" class="title" align="center"><b>'.$_language->module['sort'].'</b></td>
    </tr>';
	...
	if ($ds['catico_grp']=="1") 	$catico='<img src="../images/games/'.$ds['catico'].'.gif" alt="ICO" />';
	elseif ($ds['catico_grp']=="2") $catico='<img src="../images/flags/'.$ds['catico'].'.gif" alt="ICO" />';
	elseif ($ds['catico_grp']=="3") $catico='<img src="../images/smileys/'.$ds['catico'].'" alt="ICO" />';
	elseif ($ds['catico_grp']=="4") $catico='<img style="width:150px;" src="../images/forumico/'.$ds['catico'].'.jpg" alt="ICO" />';
	else $catico='';
	

	    echo'<tr bgcolor="#CCCCCC">
		  <td class="td_head" align="center">'.$catico.'</td>
		  <td class="td_head" align="center"> - </td>		  
		...
		elseif ($db['boardico_grp']=="4") $boardico='<img src="../images/forumico/'.$db['boardico'].'.jpg" alt="ICO" />';
		else $boardico='';
		
		if ($db['boardico_grp']=="0") {$visibil='';}
		else {
			if ($db['visibility']=="1") $visibil='<img src="images/visib.png" alt="visible"/>';
			else $visibil='<img src="images/invisib.png" alt="invisible"/>';	
			}
		
	

	      echo'<tr>
		  	<td class="'.$td.'" align="center">'.$boardico.'</td>
			<td class="'.$td.'" align="center">'.$visibil.'</td>			
	...
	while($db=mysql_fetch_array($boards)) {
	  ...
	  <td bgcolor="#FFFFFF"  align="center">'.$boardico.'</td>
	  <td bgcolor="#FFFFFF"  align="center">'.$visibil.'</td>
      <td bgcolor="#FFFFFF">&nbsp;'.getinput($db['name']).' <b>('.$_language->module['no_category'].')</b><br />&nbsp;&nbsp;<small>'.$db['info'].'</small></td>
	  <td bgcolor="#FFFFFF" align="center"><input type="button" onclick="MM_goToURL(\'parent\',\'admincenter.php?site=boards&amp;action=mods&amp;boardID='.$db['boardID'].'\');return document.MM_returnValue" value="'.$_language->module['mods'].'" /></td>
      <td bgcolor="#FFFFFF" align="center"><input type="button" onclick="MM_goToURL(\'parent\',\'admincenter.php?site=boards&amp;action=edit&amp;boardID='.$db['boardID'].'\');return document.MM_returnValue" value="'.$_language->module['edit'].'" />
      <input type="button" onclick="MM_confirm(\''.$_language->module['really_delete_board'].'\', \'admincenter.php?site=boards&amp;delete=true&amp;boardID='.$db['boardID'].'&amp;captcha_hash='.$hash.'\')" value="'.$_language->module['delete'].'" /></td>
      <td bgcolor="#FFFFFF" align="center"><select name="sort[]">';
  ...
  echo'<tr>
      <td class="td_head" colspan="7" align="right"><input type="submit" name="sortieren" value="'.$_language->module['to_sort'].'" /></td>
    </tr>
  </table>
  </form>';
}
