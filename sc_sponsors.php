...
if(mysql_num_rows($mainsponsors)) {
	...
	while($da=mysql_fetch_array($mainsponsors)) {
		if(!empty($da['banner_small'])) $sponsor='<img src="images/sponsors/'.$da['banner_small'].'" alt="" />';
...
if(mysql_num_rows($sponsors)) {
	...
	while($db=mysql_fetch_array($sponsors)) {
		if(!empty($db['banner_small'])) $sponsor='<img src="images/sponsors/'.$db['banner_small'].'" alt="" />';
