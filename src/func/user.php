...
function getguestbookuserpic($userName) {
        $ds=mysql_fetch_array(safe_query("SELECT userpic FROM ".PREFIX."user WHERE username ='".$userName."'"));
        if(!$ds['userpic']) $userpic="nouserpic.gif";
        else $userpic=$ds['userpic'];
        return $userpic;
}

function getlvisituserimg($nicknamevisitor) {
        $ds=mysql_fetch_array(safe_query("SELECT userpic FROM ".PREFIX."user WHERE username ='".$nicknamevisitor."'"));
        if(!$ds['userpic']) $userpic="nouserpic.gif";
        else $userpic=$ds['userpic'];
        return $userpic;
}

function getbudyuserpic($nicknamebuddy) {
        $ds=mysql_fetch_array(safe_query("SELECT userpic FROM ".PREFIX."user WHERE username ='".$nicknamebuddy."'"));
        if(!$ds['userpic']) $userpic="nouserpic.gif";
        else $userpic=$ds['userpic'];
        return $userpic;
}

// End Mod by Tiagof.com
