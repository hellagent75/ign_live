...
#                                                                        #
#   visit webspell.org                                                   #
#   Modded by Kode-Designs.com [ BBCODE MOD ]                            #
#                                                                        #
##########################################################################
*/
...
//Video BBCode mod by Kode-Designs.com
function tubereplace($content) {
	...
	$bg1=BG_1;
  	 ...
  	 $content = preg_replace("#\[youtube\](.*?)\[/youtube\]#si", "<object width=\"".$picsize_l."\" height=\"385\"><param name=\"movie\" value=\"http://www.youtube.com/v/\\1\"></param><param name=\"allowFullScreen\" value=\"true\"></param><param name=\"allowscriptaccess\" value=\"always\"></param><embed src=\"http://www.youtube.com/v/\\1\" type=\"application/x-shockwave-flash\" allowscriptaccess=\"always\" allowfullscreen=\"true\" width=\"".$picsize_l."\" height=\"385\"></embed></object>", $content);

//vimeo 
$content = preg_replace("#\[vimeo\]([0-9]{0,})\[/vimeo\]#si","<object width=\"".$picsize_l."\" height=\"225\"><param name=\"allowfullscreen\" value=\"true\" /><param name=\"allowscriptaccess\" value=\"always\" /><param name=\"movie\" value=\"http://vimeo.com/moogaloop.swf?clip_id=\\1&amp;server=vimeo.com&amp;show_title=1&amp;show_byline=1&amp;show_portrait=0&amp;color=&amp;fullscreen=1\" /><embed src=\"http://vimeo.com/moogaloop.swf?clip_id=\\1&amp;server=vimeo.com&amp;show_title=1&amp;show_byline=1&amp;show_portrait=0&amp;color=&amp;fullscreen=1\" type=\"application/x-shockwave-flash\" allowfullscreen=\"true\" allowscriptaccess=\"always\" width=\"".$picsize_l."\" height=\"225\"></embed></object>", $content);

//myvideo Videos einbinden [myvideo]id[/myvideo]
	$content = preg_replace("#\[myvideo\](.*?)\[/myvideo\]#si", "<object style='width:".$picsize_l."px;height:285px;' width='".$picsize_l."' height='285'><param name='movie' value='http://www.myvideo.de/movie/\\1'></param><param name='AllowFullscreen' value='true'></param><param name='AllowScriptAccess' value='always'></param><embed src='http://www.myvideo.de/movie/\\1' width='".$picsize_l."' height='285' type='application/x-shockwave-flash' allowscriptaccess='always' allowfullscreen='true'></embed></object>", $content); 

//wipido videos [wipido]id[/wipido]
	//OLD: <iframe src=\"http://www.wipido.com/main/video/external/\\1\" style=\"border:none; width:480px;height:320px;overflow:hidden;\" scrolling=\"no\" border=\"0\" frameborder=\"0\"></iframe>
	$content = preg_replace("#\[wipido\](.*?)\[/wipido\]#si", "<object width=\"".$picsize_l."\" height=\"320\"><param name=\"movie\" value=\"http://embed.minoto-video.com/90/\\1\"></param><param name=\"allowFullScreen\" value=\"true\"></param><param name=\"allowscriptaccess\" value=\"always\"></param><embed src=\"http://embed.minoto-video.com/90/\\1\" type=\"application/x-shockwave-flash\" allowscriptaccess=\"always\" allowfullscreen=\"true\" width=\"".$picsize_l."\" height=\"320\"></embed></object>", $content);
	
//xfire [xfire][/xfire]
	$content = preg_replace("#\[xfire\](.*?)\[/xfire\]#si", "<object width=\"".$picsize_l."\" height=\"344\"><embed src=\"http://media.xfire.com/swf/embedplayer.swf\" type=\"application/x-shockwave-flash\" allowscriptaccess=\"always\" allowfullscreen=\"true\" width=\"".$picsize_l."\" height=\"344\" flashvars=\"videoid=\\1\"></embed></object>", $content);

//gametrailers videos [gt]id[/gt]
	$content = preg_replace("#\[gt\](.*?)\[/gt\]#si", "<div style=\"width: ".$picsize_l."px;\"><object classid=\"clsid:d27cdb6e-ae6d-11cf-96b8-444553540000\" codebase=\"http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=8,0,0,0\" id=\"gtembed\" width=\"".$picsize_l."\" height=\"392\">	<param name=\"allowScriptAccess\" value=\"sameDomain\" /> <param name=\"allowFullScreen\" value=\"true\" /> <param name=\"movie\" value=\"http://www.gametrailers.com/remote_wrap.php?mid=\\1\"/><param name=\"quality\" value=\"high\" /> <embed src=\"http://www.gametrailers.com/remote_wrap.php?mid=\\1\" swLiveConnect=\"true\" name=\"gtembed\" align=\"middle\" allowScriptAccess=\"sameDomain\" allowFullScreen=\"true\" quality=\"high\" pluginspage=\"http://www.macromedia.com/go/getflashplayer\" type=\"application/x-shockwave-flash\" width=\"".$picsize_l."\" height=\"392\"></embed></object>", $content);
	...
	if($autoresize>0) {
		...
		foreach($imgtags as $teil) {
			...
			if($autoresize == 1) {
				...
				$content = str_ireplace('[img]'.$teil[2].'[/img]', '[url='.$teil[2].']<img src="'.fixJavaEvents($teil[2]).'" border="0" width="'.$picsize_l.'" alt="'.$teil[2].'" />', $content);
				...
				$n = str_replace(' ', '', $n);
				$content = preg_replace('#\[img\]'.preg_quote($teil[2],"#").'\[/img\]#si', '<img src="'.fixJavaEvents($teil[2]).'" id="ws_image_'.$n.'" border="0" onload="checkSize(\''.$n.'\', '.$picsize_l.', '.$picsize_h.')" alt="'.fixJavaEvents($teil[2]).'" style="max-width: '.($picsize_l+1).'px; max-height: '.($picsize_h+1).'px;" /><div id="ws_imagediv_'.$n.'" style="display:none;"></div>', $content, 1);
			}
		}
	}
...
function quotereplace($content) {
	...
	$content = preg_replace("#\[quote=(.*?)\]([^\]])#si", "[quote][b]\\1 ".$wrote.":[/b][br]\\2",$content);
	...
	$content = preg_replace("#\[quote\]#s", '<div class="quote">', $content, 10);
...
//Hide BBCode mod by Kode-Designs.com
...
//PHP Highlight BBCode mod by Kode-Designs.com
