...
function system_error($text,$system=1) {
	if($system) {
		include('version.php');
		$info='<span style="float:right;">webSPELL Version: '.$version.' - PHP Version: '.phpversion().' - MySQL Version: '.mysql_get_server_info().'</span><br />';
	} else {
		$info = '';
	}
  ...
  <div id="wrapper">
	...
	<div class="logo"><img src="./sm/logo.png" alt=""/></div> 
        ...
        '.$text.'
		'.$info.'</br>
		<h3>Need Support?</h3></br>
		Website Support: <a href="http://shamedia.net">Shamedia.net</a></br></br>
		Email Support: <a href="mailto:sales@shamedia.net?Subject=Red%20Template%20Install%20Support" target="_blank">sales@shamedia.net</a>		
        </div>
